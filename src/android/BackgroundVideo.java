...
public class BackgroundVideo extends CordovaPlugin {
    ...
    private void Start(JSONArray args) throws JSONException {
        ...
        final String quality = args.getString(3);
        final boolean onlyPreview = args.getBoolean(4);
            ...
            cordova.getActivity().runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    try {
                        ...
                        containerView.addView(videoOverlay, new ViewGroup.LayoutParams(displaymetrics.widthPixels, displaymetrics.heightPixels-400));
        ...
        videoOverlay.setQuality(quality);
        videoOverlay.setOnlyPreview(onlyPreview);
